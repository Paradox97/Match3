...
{
    class HorizontalDestroyer:ICloneable
    {
        ...
        public HorizontalDestroyer(Figure figure, int newType, Paths paths, ContentManager content) //creating new figure from another one
        {
        ...
        public HorizontalDestroyer(int horizontalPos, int verticalPos, int type, float offset, Vector2 fieldBounds, Paths paths, ContentManager content)
        {
        ...
        public HorizontalDestroyer(Vector2 position, Vector2[] bounds, int type, Paths paths, ContentManager content) //creating figure at position
        {
